...
define("gallery/store/1.3.7/store", [], function (e, t, r) {
  (function () {
    function e() {
      ...
      return function () {
        var t = Array.prototype.slice.call(arguments, 0);t.unshift(i), f.appendChild(i), i.addBehavior("#default#userData"), i.load(c);var r = e.apply(o, t);return f.removeChild(i), r;
      };
    }function n(e) {
      return e.replace(v, "___");
        ...
        u = a.document,
        c = "localStorage",
        l = "__storejs__";if (o.disabled = !1, o.set = function () {}, o.get = function () {}, o.remove = function () {}, o.clear = function () {}, o.transact = function (e, t, r) {
      var n = o.get(e);null == r && (r = t, t = null), n === void 0 && (n = t || {}), r(n), o.set(e, n);
    }, o.getAll = function () {}, o.serialize = function (e) {
      return JSON.stringify(e);
    }, o.deserialize = function (e) {
      if ("string" != typeof e) return void 0;try {
        return JSON.parse(e);
      } catch (t) {
        return e || void 0;
      }
      ...
      var f, d;try {
      ...
      }var v = RegExp("[!\"#$%&'()*+,/\\\\:;<=>?@[\\]^`{|}~]", "g");o.set = t(function (e, t, r) {
        ...
        var t = e.XMLDocument.documentElement.attributes;e.load(c);for (var r, n = 0; r = t[n]; n++) {
          e.removeAttribute(r.name);
        }e.save(c);
      }), o.getAll = t(function (e) {
        for (var t, r = e.XMLDocument.documentElement.attributes, i = {}, a = 0; t = r[a]; ++a) {
          var u = n(t.name);i[t.name] = o.deserialize(e.getAttribute(u));
        }return i;
      });
    }try {
